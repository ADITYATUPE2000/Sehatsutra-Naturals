          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-300 hover:text-white transition-colors">
                ...
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C3.85 14.724 3.85 12.78 3.85 12.017s0-2.707 1.276-3.674C5.951 7.536 7.102 7.046 8.449 7.046s2.498.49 3.374 1.297c.875.807 1.297 1.958 1.297 3.674s-.422 2.867-1.297 3.674c-.876.807-2.027 1.297-3.374 1.297z"/>
                </svg>
              </a>
            </div>
          </div>
